...
class KeyboardViewController: UIInputViewController {
    ...
    var leftKeyboard: Keyboard!
    var rightKeyboard: Keyboard!
...
//        self.touchPadView = UIView()
//        self.touchPadView.backgroundColor = UIColor.blue
//
//        self.forwardingView.addSubview(self.touchPadView)
    ...
    */
    ...
    override func viewDidLayoutSubviews() {
        ...
        let touchPadView = TouchpadView();
        touchPadView.backgroundColor = UIColor.clear;
        touchPadView.frame = CGRect(x: CGFloat(28*5+7*6 + 4 + 16), y: CGFloat(0), width: CGFloat(220), height: CGFloat(self.forwardingView.frame.size.height))
        self.forwardingView.addSubview(touchPadView);
...
//        self.touchPadView?.frame = CGRect(x: 28*5+7*6 + 4 + 16, y: 0, width: 220, height: self.forwardingView.frame.size.height)
    }
